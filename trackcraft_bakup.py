...
from trackcraft.metadata_ingest import load_metadata
from trackcraft.metadata_analyze import analyze
...
if __name__ == "__main__":
    df0 = load_metadata("inputs/metadata")
    # df0.to_csv("~/Desktop/df1.csv", index=False, sep="\t")  #  raw metadata
    
    analyze(df0, do_report=True, do_plot=False)
