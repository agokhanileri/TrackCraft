...
# =================================================================================================
# 1) Access the tracks, capture and visualize metadata
...
for file in os.listdir(input_path):
    if file.endswith((".mp3", ".flac", ".wav", ".m4a", ".aiff")):  # Supported formats
...
metadata[0]['Karol G - Bichota.aiff']          # access brute-force
